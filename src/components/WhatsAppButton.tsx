...
export default function WhatsAppButton() {
  return (
    <Link 
      ...
      className="fixed right-6 bottom-6 z-50 animate-bounce hover:animate-none transition-all duration-300"
    >
      <div className="bg-[#25D366] p-4 rounded-full shadow-lg hover:shadow-xl transition-shadow duration-300">
        <svg 
